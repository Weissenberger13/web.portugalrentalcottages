...
{
    public partial class PortVillasContext : DbContext
    {
        static PortVillasContext()
        {
            Database.SetInitializer<PortVillasContext>(null);
        }

        public PortVillasContext()
            : base("Name=PortVillasContext")
        {
        }
